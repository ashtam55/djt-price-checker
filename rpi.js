...
function onMessageArrived(msg) {
    ...
    // console.log(token);
    var token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..RShA4crmwSQqQIyV6daeDAMrFuHeErU4GUJ5Y0zXGm4";
    //   var bodyToSend = {
    //     "export": false,
    //     "search": "number",
...
const buildCartItem = function (order) {
    ...
    _1h2.setAttribute("class", "text-base font-semibold text-2xl");
    ...
    _2p.setAttribute("class", "text-base font-semibold text-3xl");
